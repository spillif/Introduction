...
PROJECTS = {
    ...
    "🏆 Others": "https://github.com/spillif",
}
CERTIFICATE = {
    "🗝️ Google Data Analytics": "https://www.coursera.org/account/accomplishments/specialization/certificate/7ELKEW2WR6MZ",
    "🗝️ IBM Data Science": "https://www.coursera.org/account/accomplishments/specialization/certificate/GCBDHHTA6BFR",
    "🗝️ IBM Data Analyst": "https://www.coursera.org/account/accomplishments/specialization/certificate/YRWV5HC3KU7M",
    "🗝️ Microsoft Excel Advanced": "https://github.com/spillif/Introduction/tree/main/certificates",
    "🗝️ Others": "https://github.com/spillif/Introduction/tree/main/certificates",
}
...
# --- JOB 1
st.write('\n')
st.write("🏢", "**Warranty and Service Data Analyst  | [SVP Vietnam Co., Ltd](https://en.wikipedia.org/wiki/SVP_Worldwide)**")
...
# --- JOB 2
st.write('\n')
st.write("🏢", "**Service Quality Specialist  | [APL Logistics Ltd. (APLL)](https://en.wikipedia.org/wiki/APL_Logistics)**")
...
- ► SEA data reporting lead. Support creating reports via Brio/ Excel/ etc. per request. Enhance the manual report by applying the automation and macro to schedule the refresh query and send the catch-up request.
- ► Support creating the macro to tighten the process and reduce 15% of the current manual work
